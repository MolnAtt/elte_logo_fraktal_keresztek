...
namespace LogoKaresz
{
	public class Avatar
	{
		...
		public Color tollszín { get => toll.Color; set => toll.Color = value; }
		public float tollvastagság { get => toll.Width; set => toll.Width = value; }
		...
		public class Ideiglenesen : IDisposable
		{
			double x;
			Action<double> eljárás;
			public Ideiglenesen(Action<double> eljárás, double x)
			{
				(this.eljárás, this.x) = (eljárás, x);
				eljárás(x);
			}
			public void Dispose()
			{
